...
public class DialoguePane extends VBox {
   ...
   public static VBox getSpadeDialoguePane(Button leftButton, Button rightButton, String promptText, Insets promptInsets, int leftGold, int rightGold, int leftWorker, int rightWorker, int leftPriest, int rightPriest)
   {
      // Prompt
      Label prompt = new Label(promptText);
      prompt.setTextFill(Color.ORANGE);
      ...
      ImageView workerIm1 = new ImageView(new Image("worker.png"));
      workerIm1.setFitHeight(30);
      workerIm1.setFitWidth(30);
      ...
      // Dwelling
      HBox requiredResourcesForLeft = new HBox();
      requiredResourcesForLeft.setSpacing(30);
      requiredResourcesForLeft.getChildren().addAll(goldIm, leftGoldLabel, leftPriestIm, leftPriestLabel, workerIm1, leftWorkerLabel);
      VBox leftBox = new VBox();
      leftBox.getChildren().addAll(leftButton, requiredResourcesForLeft);
      leftBox.setSpacing(30);
      ...
      // Empty Terrain
      HBox requiredResourcesForRight = new HBox();
      requiredResourcesForRight.setSpacing(30);
      requiredResourcesForRight.getChildren().addAll(goldIm2, rightGoldLabel, rightPriestIm, rightPriestLabel, workerIm2, rightWorkerLabel);
      VBox rightBox = new VBox();
      rightBox.getChildren().addAll(rightButton, requiredResourcesForRight);
      rightBox.setSpacing(30);
